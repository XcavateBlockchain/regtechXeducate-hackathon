# Employee and customer Documentation
...
1. [How employees and customers differ](#01-how-employees-and-customers-differ)
...
## 01 How employees and customers differ

Both employees and customers complete the same types of modules and earn the same credentials. The difference is in how you get started:
...
> **Good to know**
> Each account can only have one role. If you already use your Google account as a company owner, you'll need a different Google account to join as an employee or customer.
...
![Invite link landing page showing company name, assigned role, and Claim invite button](screenshots-customer/image1.png)
...
![customer module landing page with company name, module description, and Join button](screenshots-customer/image2.png)
...
![Full participant dashboard showing overview stats and modules tab](screenshots-customer/image3.png)
...
![Modules tab showing one module card with status badge and stats](screenshots-customer/image4.png)
...
![Credentials tab showing credential with active status](screenshots-customer/image5.png)
...
![Module intro page with title, description, quiz details, and Begin quiz button](screenshots-customer/image6.png)
...
![Active quiz screen with question, answer options, progress bar, and timer](screenshots-customer/image7.png)
...
![Results screen with Failed badge, score percentage, and question review](screenshots-customer/image8.png)
