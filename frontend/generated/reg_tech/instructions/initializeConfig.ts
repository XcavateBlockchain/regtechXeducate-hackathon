...
export type InitializeConfigInstructionData = {
  ...
  defaultPassThresholdBps: number;
  defaultCooldownSeconds: bigint;
};

export type InitializeConfigInstructionDataArgs = {
  defaultPassThresholdBps: number;
  defaultCooldownSeconds: number | bigint;
};
...
export function getInitializeConfigInstructionDataEncoder(): FixedSizeEncoder<InitializeConfigInstructionDataArgs> {
  return transformEncoder(
    getStructEncoder([
      ...
      ["defaultPassThresholdBps", getU16Encoder()],
      ["defaultCooldownSeconds", getI64Encoder()],
    ]),
...
export function getInitializeConfigInstructionDataDecoder(): FixedSizeDecoder<InitializeConfigInstructionData> {
  return getStructDecoder([
    ...
    ["defaultPassThresholdBps", getU16Decoder()],
    ["defaultCooldownSeconds", getI64Decoder()],
  ]);
}
...
> = {
  ...
  defaultPassThresholdBps: InitializeConfigInstructionDataArgs["defaultPassThresholdBps"];
  defaultCooldownSeconds: InitializeConfigInstructionDataArgs["defaultCooldownSeconds"];
};
